...
## TODO: imsize1, imsize2가 각각 h, w임 이거를 깔끔하게 넣기
...
class DeepVO(nn.Module):
    def __init__(self, imsize1=128, imsize2=160, n_channel=2, batchNorm=True):
        super(DeepVO,self).__init__()
        # CNN
        self.batchNorm = batchNorm
        self.clip = par.clip
        self.conv1   = conv(self.batchNorm,  n_channel,  64, kernel_size=7, stride=2, dropout=par.conv_dropout[0])
        ...
        __tmp = Variable(torch.zeros(1, n_channel, imsize1, imsize2))
