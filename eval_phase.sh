...
CKPT_FILE="./checkpoints/d256_synth10_fringe_baye_depthmin200_disp/model_10.ckpt"
OUT_PATH="C:/Dev/MVSNet/outputs/uph/256_synth10_fringe_baye_depthmin200_disp"
...
python eval_phase.py --dataset=dtu_yao_phase --batch_size=1 --numdepth=256 --testpath=$DTU_TESTING --testlist lists/dtu/test.txt \
     --loadckpt $CKPT_FILE --outdir $OUT_PATH
